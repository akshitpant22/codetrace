...
import { Eye, EyeOff, Loader2, Code2, Cpu, ShieldCheck } from "lucide-react";
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Verify OTP</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-[#8888aa] ml-1">6-Digit OTP</label>
              <input
                type="text"
                required
                maxLength={6}
                ...
                className="w-full px-4 py-3 bg-[#0a0a0f]/50 border border-[#1e1e2e] rounded-xl text-white placeholder-[#8888aa]/40 focus:outline-none focus:border-[#00ff9f] focus:ring-1 focus:ring-[#00ff9f] transition-all duration-300 tracking-widest text-center text-xl font-mono"
                placeholder="000000"
              />
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium text-[#8888aa] ml-1">New Password</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-[#8888aa] ml-1">Confirm New Password</label>
              <div className="relative">
                <input
