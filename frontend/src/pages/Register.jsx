      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-[#8888aa] text-sm">Start detecting plagiarism today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-[#8888aa] ml-1">Password</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-[#8888aa] ml-1">Confirm Password</label>
              <div className="relative">
                <input
